  ...
  _createClass(StopWatch, [{
    ...
    value: function start() {
      ...
      if (!this.timer) {
        ...
        this.timer = setInterval(function () {
          ...
          startTime = stopTime;
        }, 100); // Executed every 250 millisecond
      }
    }
  }, {
    key: "stop",
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          "h2",
          { className: "border px-3 py-4 rounded my-3 mx-auto text-center", style: { maxWidth: "auto" } },
          Math.floor(this.state.timePassedInMilliSeconds / 100) / 10,
          " s"
        ),
        React.createElement(
          "div",
